...
class NexeverCheckPlugin : FlutterPlugin, MethodChannel.MethodCallHandler {
    ...
    private fun isDebuggerConnected(): Boolean {
        ...
        Log.d(
            "DebuggerCheck",
            "isRunningEmulator: $isRunning, Debugger connected: $isConnected, Waiting for debugger: $isWaiting"
        )
    ...
    private fun isRunningOnEmulator(): Boolean {
        return (Build.FINGERPRINT.startsWith("generic") || Build.FINGERPRINT.startsWith("unknown") ||
                ...
                Build.MANUFACTURER.contains("Genymotion") || Build.MANUFACTURER.contains("Google") ||
